...
int main() {
    std::string text = "hel"; // Очень короткая последовательность
    ...
    rnn.train(inputs, targets, 0.1, 10000); // Увеличили скорость обучения
    ...
    std::string generated_text = "";
     ...
     for(int i = 0; i < 4; i++) { // Generate 4 symbols max.
